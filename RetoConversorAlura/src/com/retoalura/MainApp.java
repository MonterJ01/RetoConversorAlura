package com.retoalura;

import com.retoalura.models.Historial;
import com.retoalura.models.Moneda;
import java.util.*;
...
public class MainApp {
        ...
        while (true){
            ...
            if(user.matches("^\\d{1}$")){
                if (Integer.valueOf(user) > 7){
                    System.out.println("El valor ingresado no es valido, intentelo de nuevo \n");
                }else {
    ...
    public static double validarIngresoMoneda(){
        Scanner entrada = new Scanner(System.in);
        System.out.println("Ingrese el monto que quiere cambiar: ");
        while (true){
            String user = entrada.nextLine().trim();
